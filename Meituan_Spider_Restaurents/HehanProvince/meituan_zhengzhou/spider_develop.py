...
restaurants infos in zhengzhou city.(City id is 73)
'''
...
from settings import headers,savePath,filename,limit
...
class MeituanSpider(object):
    ...
    baseUrl = ("http://api.meituan.com/group/v4/deal/select/city/73/cate/1?"
    ...
    def __init__(self, saveMode='csv'):
        ...
        if saveMode not in self.modeList:
            raise RuntimeError('存储模式指定有误，请输入txt或者csv')
        self.saveMode = saveMode
        print('>>>>  App Spider is ready.')
